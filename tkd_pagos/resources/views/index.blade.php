...
<head>
    ...
    <title>Control de Pagos - Taekwondo</title>
    <!-- Usamos Tailwind CSS para un diseño limpio y administrativo -->
...
<body class="bg-gray-50 min-h-screen p-6 font-sans text-gray-800">
    ...
    <div class="max-w-7xl mx-auto">
        ...
        <header class="mb-8 border-b pb-4">
            <h1 class="text-3xl font-bold text-gray-900">Control de Pagos</h1>
            <p class="text-gray-500">Panel administrativo - Escuela de Taekwondo</p>
        </header>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
                ...
                <!-- Contenedor de Alertas de Error del Formulario -->
                ...
                <form id="form_pago" class="space-y-4">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <!-- Este campo se mostrará/ocultará dinámicamente -->
            ...
            <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
                ...
                <!-- Contenedor de Error de Consulta -->
                <div id="consulta_error" class="hidden mb-4 p-3 bg-red-50 text-red-700 text-sm rounded-md border border-red-200">
                </div>
    ...
    <script>
        // CONFIGURACIÓN: Ajusta la URL según corresponda
        const API_URL = 'http://localhost:8002/api';

        // --- LÓGICA DE LA INTERFAZ ---

        // Prellenar la fecha de pago con el día actual
        document.getElementById('fecha_pago').valueAsDate = new Date();

        // Mostrar/Ocultar Número de Rastreo condicionalmente
        ...
        document.getElementById('form_pago').addEventListener('submit', async (e) => {
            ...
            try {
                ...
                if (response.status === 422) {
                    ...
                    // Laravel devuelve los errores en un objeto "errors": { campo: ["Mensaje 1"], ... }
                    if (data.errors) {
                        ...
                        // Por si acaso el error viene en el message global
                        const li = document.createElement('li');
                    ...
                    document.getElementById('fecha_pago').valueAsDate = new Date();
                    metodoPagoSelect.dispatchEvent(new Event('change')); // reiniciar vista de rastreo

                    // (Opcional) Si el alumno que se pagó está actualmente consultado, recargar estado
